...
let Chaincode = class {
  ...
  // The Init method is called when the Smart Contract 'aigccp' is instantiated by the blockchain network
  // Best practice is to have any Ledger initialization in separate function -- see initLedger()
  async Init(stub) {
    console.info('=========== Instantiated aigccp chaincode ===========');
    return shim.success();
  }

  // The Invoke method is called as a result of an application request to run the Smart Contract
  // 'aigccp'. The calling application program has also specified the particular smart contract
