...
package org.hyperledger.fabric.samples.aigccp;
...
@Default
public final class AigcCp implements ContractInterface {

    private final Genson genson = new Genson();

    private enum AigcCpErrors {
        CAR_NOT_FOUND,
        CAR_ALREADY_EXISTS
    }
    ...
    public Car queryCar(final Context ctx, final String key) {
        ...
        if (carState.isEmpty()) {
            ...
            throw new ChaincodeException(errorMessage, AigcCpErrors.CAR_NOT_FOUND.toString());
        }
    ...
    public Car createCar(final Context ctx, final String key, final String make, final String model,
        ...
        if (!carState.isEmpty()) {
            ...
            System.out.println(errorMessage);
            throw new ChaincodeException(errorMessage, AigcCpErrors.CAR_ALREADY_EXISTS.toString());
        }
